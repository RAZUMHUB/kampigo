            ...
            <div className="grid gap-3 border-t border-ink-100 bg-ink-50/70 p-6 sm:grid-cols-2 lg:grid-cols-1 lg:border-l lg:border-t-0 lg:p-8">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <Card className="p-4 text-center">
                  <p className="text-2xl font-bold text-blue-600">{dashboard?.stats.lostItems ?? '--'}</p>
                ...
                <Card className="p-4 text-center">
                  <p className="text-2xl font-bold text-emerald-600">{dashboard?.stats.returnedItems ?? '--'}</p>
                  <p className="mt-1 text-xs text-ink-500">
                    Returned
                  </p>
                </Card>
                ...
                <Card className="p-4 text-center">
                  <p className="text-2xl font-bold text-violet-600">{dashboard?.stats.students ?? '--'}</p>
                  <p className="mt-1 text-xs text-ink-500">
                    Students
                  </p>
                </Card>
